        ...
        <Tooltip title={kotdInfo?.secondaryText ?? ''} placement='bottom' arrow>
          <Box
            ...
            sx={{
              ...
              border: '1px solid',
              borderColor: isKotdLearned ? '#86efac' : '#fde68a',
              borderRadius: 1,
              px: 0.5,
              py: 0.2,
              cursor: 'pointer',
          ...
          >
            ...
            <Typography
              sx={{ fontSize: 16, fontWeight: 'bold', lineHeight: 1.1 }}
            >
              {keyOfDay}
            </Typography>
          </Box>
            ...
            [
              {
                val: 'g',
                label: 'g',
                tip: 'g prefix — overlay g+key commands',
              },
              {
                val: 'z',
                label: 'z',
                tip: 'z prefix — overlay z+key commands (folds, scroll)',
              },
              {
                val: 'ctrl',
                label: '^',
                tip: 'Ctrl prefix — overlay Ctrl+key commands',
              },
            ] as const
          ).map(({ val, label, tip }) => (
            <ToggleButton
